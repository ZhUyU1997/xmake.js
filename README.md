...
Xmake.js is a script-only build utility like autotools.
...
Copy `./configure.js` script file to your project root directory.

### Write project configuration

We just write `xmake.js` project file, like this:
